 ...
 * @param epsilon - Maximum allowed error (defaults to EPSILON)
 */
export function expectComplexCloseTo(z: Complex, expected: Complex, epsilon: number = TEST_EPSILON): void {
 ...
 * @param epsilon - Maximum allowed error (defaults to EPSILON)
 */
export function expectPolarCloseTo(polar: Polar, expected: Polar, epsilon: number = TEST_EPSILON): void {
